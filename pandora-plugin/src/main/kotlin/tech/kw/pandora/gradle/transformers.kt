package tech.kw.pandora.gradle
                ...
                ?.let { instructions ->
                    Iterable { instructions.iterator() }
                            ...
                            ?.let { src ->
                                ...
                                // interceptors.add(tech.kw.pandora.Pandora.get().getInterceptor())
                                src.append(VarInsnNode(ALOAD, 0))
                                        .append(FieldInsnNode(GETFIELD, src.owner, src.name, src.desc))
                                        .append(MethodInsnNode(INVOKESTATIC, "tech/kw/pandora/Pandora", "get", "()Ltech/kw/pandora/Pandora;", false))
                                        .append(MethodInsnNode(INVOKEVIRTUAL, "tech/kw/pandora/Pandora", "getInterceptor", "()Ltech/kw/pandora/network/OkHttpInterceptor;", false))
